...
set output 'part2_tcp_tb.png' 
set size 1,1
set key bottom right
set key vertical

plot "part2_tcp_tb.txt" using 1:2 index 0 with linespoints ls 1 title "Throughput vs Delay for TCP at 1 ms",\
 "part2_tcp_tb.txt" using 1:3 index 0 with linespoints ls 2 title "Throughput vs Delay  for TCP at 10 ms", \
 "part2_tcp_tb.txt" using 1:4 index 0 with linespoints ls 3 title "Throughput vs Delay for TCP at 100 ms"
