...
set xlabel "Delay (ms)" font "Times-Roman:bold, 16" offset 0,-0.5
...
set output 'part2_udp_2048_d.png' 
set size 1,1
set key bottom right
set key vertical

plot "d.txt" using 1:2 index 0 with linespoints ls 1 title "Throughput vs Delay for UDP at 1 ms",\
 "d.txt" using 1:3 index 0 with linespoints ls 2 title "Throughput vs Delay  for UDP at 10 ms", \
 "d.txt" using 1:4 index 0 with linespoints ls 3 title "Throughput vs Delay for UDP at 100 ms"
