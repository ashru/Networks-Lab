...
set xlabel "UDP bandwidth (Kbps)" font "Times-Roman:bold, 16" offset 0,-0.5
set ylabel "UDP throughput (Kbps)" font "Times-Roman:bold, 16" offset -1
...
plot "part1.txt" using 1:2 index 0 with linespoints ls 1 title "UDP throughput vs bandwidth"
